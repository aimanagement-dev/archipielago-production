        ...
        GoogleProvider({
            ...
            authorization: {
                params: {
                    ...
                    access_type: "offline",
                    response_type: "code",
                    scope: "openid email profile https://www.googleapis.com/auth/drive https://www.googleapis.com/auth/drive.file https://www.googleapis.com/auth/spreadsheets https://www.googleapis.com/auth/calendar https://www.googleapis.com/auth/contacts.readonly https://www.googleapis.com/auth/gmail.send",
                },
            },
        }),
    ],
    callbacks: {
        async signIn({ user, account }) {
            ...
            const allowedEmails = (process.env.ALLOWED_LOGIN_EMAILS ||
                'ai.management@archipielagofilm.com,ai.lantica@lanticastudios.com')
                .split(',')
